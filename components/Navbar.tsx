...
import { useTheme } from './ThemeContex';  // Import the useTheme hook
...
export const Navbar = () => {
    ...
    return (
        <div className="z-50 fixed flex justify-center w-full text-white font-bold">
            ...
            <button 
                onClick={toggleTheme} 
                className="fixed top-5 right-5 md:right-20 bg-white/10 p-2 rounded-full backdrop-blur-lg shadow-md transition-all hover:bg-white/20"
            >
                {theme === "dark" ? "🌞" : "🌙"}
            </button>
            ...
            <div className={`fixed left-0 w-full h-full bg-black/90 transform transition-transform duration-300 ${nav ? 'translate-x-0': 'translate-x-full'}`}>
