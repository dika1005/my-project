...
export const Contact = () => {
  return (
    <section
      id="contact"
      className="overflow-x-clips py-32 text-white max-w-[1200px] mx-auto px-4"
    >
      <motion.div
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <a
                href="mailto:dik@gmail.com"
                className="text-3xl lg:text-3-xl font-semibold hover:text-purple-400 transition duration-300 flex items-center gap-2"
              >
